...
<div class="slider-container text-center">
    ...
    <div class="main-block container">
        ...
        <div class="main-block-footer d-flex justify-content-between align-items-md-baseline flex-wrap">
            ...
            <div>
                <img src="<?php echo get_template_directory_uri() . '/img/seo/fast_result.png' ?>">
        ...
        <div class="d-flex flex-row justify-content-between row-item flex-wrap flex-md-nowrap">
            <div class="d-flex flex-row align-items-center">
                ...
                <div class="item-block">
                    <img src="<?php echo get_template_directory_uri() . '/img/seo/1.png' ?>"/>
                    <span>1</span>
                </div>
            </div>
            <div class="d-flex flex-row align-items-center">
            ...
            <div class="d-flex flex-row align-items-center">
                ...
                <div class="item-block">
                    <img src="<?php echo get_template_directory_uri() . '/img/seo/3.png' ?>">
                    <span>3</span>
                </div>
            </div>
            <div class="d-flex flex-row align-items-center">
                ...
                <div class="item-block">
                    <img src="<?php echo get_template_directory_uri() . '/img/seo/4.png' ?>">
                    <span>4</span>
                </div>
            </div>
            <div class="d-flex flex-row align-items-center">
                ...
                <div class="item-block">
                    <img src="<?php echo get_template_directory_uri() . '/img/seo/5.png' ?>">
                    <span>5</span>
                </div>
            </div>
        </div>
